<div class="container">
    <div class="row justify-content-center align-content-center ">
        <div class="col formbox">
            ...
            <div class="form">
                <form action="?nav=database" method="POST">
                    <input type="hidden" name="id" value="<?php echo $student["id"];  ?>">
                    <label for="name">Enter Your Full name:</label> <br>
                    <input type="text" name="fullname" placeholder="E.g Shakib Shown" value="<?php echo  $student["name"]; ?>"> <br>
                    <?php if ($error == 1) { ?>
                        <div class="bg-red p-2 ">
                            <h6 class=" text-left wrong">Please change the name, We already have a "<?php echo $student["name"]; ?>"" in our Record</h6>
                        </div> <?php
